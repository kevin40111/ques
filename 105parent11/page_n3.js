...
$("#QID_gk8epwfh").hover(function() {
    var tooltip2 = $("<div id='tooltip2' class='tooltip'>說明：本份問卷都請根據OOO的情況填答。請由學生之家長或監護人親自填答，勿由他人代答。以維持資料正確性。</div>");
...
$('input[name=p3s14t2]').change(function() {
    var name = $('Input[name=p3s14t2]').val();
