...
return array(
    ...
    'publicData' => function($data) {
        ...
        switch($data){
            case 'departments':
                $departments = DB::table('rows.dbo.row_20170518_150111_rkm25')->where('C3269', 104)->groupBy('C3270')->orderByRaw('C3270 COLLATE Chinese_PRC_Stroke_ci_as')->select('C3270 AS department_name')->get();
