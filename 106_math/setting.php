...
return array(
    ...
    'logInput' => true,
    'logInputDir' => '//192.168.0.125/quesnlb_ap/WEB_log/QUES-DB/106_math',

    'auth' => array(
        'loginView' => array(
            'intro' => 'ques.data.106_math.intro',
            'head' => 'ques.data.106_math.head',
            'body' => 'ques.data.106_math.body',
            'footer' => 'ques.data.106_math.footer'
        ),
        'endView' => 'ques.data.106_math.end',
        'testID' => 'A228909170',
        'primaryID' => 'newcid',
        'input_rull' => array(
        ...
        'checker' => function(&$validator,$controller){
            ...
            if($checkid != true) {
                ...
                Ques\Answerer::login('106_math', $pcreate_newcid);
            }
        }
    ),
